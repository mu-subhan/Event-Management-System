      ...
      <div className="container mx-auto px-4 md:px-6 z-10 py-20">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <h1 
              className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight animate-on-load opacity-0 translate-y-8 transition-all duration-700"
            >
              Organize & Discover <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Meaningful Events</span>
            </h1>
            
            <p 
              className="mt-6 text-lg md:text-xl text-gray-300 max-w-lg mx-auto lg:mx-0 animate-on-load opacity-0 translate-y-8 transition-all duration-700 delay-300"
            >
              Your all-in-one platform to create, manage, and join community events that matter. Connect with like-minded individuals and make an impact together.
            </p>
