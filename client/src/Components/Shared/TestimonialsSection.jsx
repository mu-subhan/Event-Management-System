    ...
    <section id="testimonials" className="py-20 bg-purple-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12 px-2">
          ...
          <p className="text-lg text-gray-600">Hear from our volunteers and organizers</p>
        </div>
          ...
          <div className="overflow-hidden">
            ...
            >
              {testimonials.map((testimonial, index) => (
                <div key={index} className="w-full flex-shrink-0 px-4 sm:px-8 md:px-12 lg:px-24">
