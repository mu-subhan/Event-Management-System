...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    console.log("eventsCount adminDashboard: ", eventsCount);
  }, []);
  return (
    // {isLoading?(<div className="flex min-h-screen bg-gray-50">Loading</div>}):(<div></div>)}
    <>
      {isLoading ? (
        <span>Loading</span>
      ) : (
        <div className="flex min-h-screen bg-gray-50">
          ...
          <div
            className={`flex-1 ml-64 transition-all duration-300 ${
              location.pathname === "/admin/dashboard" ? "ml-64" : ""
            }`}
          >
            {/* Top Header */}
                  ...
                  <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500 hover:shadow-lg transition-shadow">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <h3 className="text-3xl font-bold text-gray-800">
                          {roleCounts && roleCounts?.Volunteer}
                        </h3>
                      </div>
                    </div>
                    <div className="mt-4 text-sm text-green-600">
