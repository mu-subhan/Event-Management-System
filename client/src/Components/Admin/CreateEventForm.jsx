...
import { FaCalendarAlt, FaMapMarkerAlt, FaUserFriends, FaImage, FaClock } from 'react-icons/fa';
...
const CreateEventForm = () => {
  ...
  const handleAddRole = () => {
    setEventData({
      ...eventData,
      requiredRoles: [...eventData.requiredRoles, { title: '', count: 1, description: '' }]
    });
  };
      ...
      <div className="flex-1 ml-64 p-6">
        <div className="bg-white rounded-xl shadow-lg max-w-4xl mx-auto">
          <div className="p-6 border-b">
            ...
            <p className="text-gray-600 mt-1">Fill out the form below to create a new volunteer event</p>
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-medium text-gray-600">
                  {currentStep === 1 ? 'Basic Information' : 
                   currentStep === 2 ? 'Event Details' : 'Volunteer Roles'}
                </span>
              </div>
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Leave blank for unlimited volunteers</p>
                </div>
                  ...
                  <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg">
                    <div className="space-y-1 text-center">
                      ...
                      <div className="flex text-sm text-gray-600">
                        <label htmlFor="eventImage" className="relative cursor-pointer bg-blue-50 hover:bg-blue-100 px-3 py-2 rounded-lg text-sm font-medium text-blue-600">
