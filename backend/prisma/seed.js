  ...
  const volunteers = await Promise.all([
    prisma.user.create({
      data: {
        ...
        experienceYears: 2,
        description: 'Medical student passionate about community health initiatives',
        profileImage: {
    ...
    prisma.user.create({
      data: {
        ...
        experienceYears: 3,
        description: 'Creative professional supporting environmental awareness campaigns',
        profileImage: {
    ...
    prisma.user.create({
      data: {
        ...
        experienceYears: 4,
        description: 'Psychology graduate working in community mental health support',
        profileImage: {
  ...
  const events = await Promise.all([
    prisma.event.create({
      data: {
        ...
        description: 'Free medical checkup and health awareness program for the local community. We will provide basic health screening, blood pressure checks, diabetes testing, and health education sessions.',
    ...
    prisma.event.create({
      data: {
        ...
        description: 'Interactive learning sessions covering basic mathematics, English, and computer literacy for children from low-income families.',
    ...
    prisma.event.create({
      data: {
        ...
        description: 'Join us for a community-wide cleanup initiative to make our neighborhood cleaner and greener. We will clean parks, streets, and plant trees.',
        startTime: new Date(currentDate.getTime() + 3 * 24 * 60 * 60 * 1000), // 3 days from now
        endTime: new Date(currentDate.getTime() + 3 * 24 * 60 * 60 * 1000 + 3 * 60 * 60 * 1000), // 3 hours later
    ...
    prisma.event.create({
      data: {
        ...
        description: 'Monthly food distribution program for families in need. We provide essential groceries and cooked meals.',
        startTime: pastDate,
    ...
    prisma.event.create({
      data: {
        ...
        description: 'Computer and internet training sessions for seniors and those new to technology. Basic computer skills, email, and online safety.',
  ...
  const notifications = await Promise.all([
    ...
    prisma.notification.create({
      data: {
        ...
        message: 'Muhammad Hassan has applied to volunteer for the Community Health Camp event.',
        status: 'Unread'
      }
    }),
    prisma.notification.create({
      data: {
        ...
        message: 'Your Digital Literacy Training event is starting in 1 hour. Please make sure all preparations are complete.',
        status: 'Read'
      }
    }),
    ...
    prisma.notification.create({
      data: {
        ...
        message: 'Food Distribution Drive has been completed successfully. 50 families were served.',
        status: 'Read'
      }
    }),
    prisma.notification.create({
    ...
    prisma.notification.create({
      data: {
        ...
        message: 'You have been assigned as Medical Assistant for the Community Health Camp. Event details have been sent to your email.',
        status: 'Read'
      }
    }),
    prisma.notification.create({
      data: {
        ...
        message: 'You have an upcoming event: Educational Workshop for Underprivileged Children in 3 days.',
        status: 'Unread'
      }
    }),
    prisma.notification.create({
      data: {
        ...
        message: 'Thank you for your excellent work as Documentation Specialist. Your photos really helped promote our cause!',
        status: 'Unread'
      }
    }),
    prisma.notification.create({
      data: {
        ...
        title: 'Event Update',
        message: 'The location for Community Health Camp has been updated. Please check event details.',
        status: 'Dismissed'
      }
    }),
    prisma.notification.create({
      data: {
        ...
        message: 'A new training session for advanced IT skills is available. Would you like to participate?',
        status: 'Unread'
      }
    }),
    ...
    prisma.notification.create({
      data: {
        ...
        message: 'The platform will undergo maintenance on Sunday from 2 AM to 4 AM. Limited functionality may be available.',
        status: 'Unread'
      }
    }),
    prisma.notification.create({
  ...
  const eventTests = await Promise.all([
    prisma.eventTest.create({
      data: {
        ...
        endTime: new Date(currentDate.getTime() + 5 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000),
        status: 'UPCOMING',
        isPass: false
      }
    }),
    ...
    prisma.eventTest.create({
      data: {
        ...
        endTime: new Date(currentDate.getTime() + 10 * 24 * 60 * 60 * 1000 + 3 * 60 * 60 * 1000),
        status: 'PENDING',
        isPass: false
      }
    })
